<?php
    ...
    //
    //Informando ao navegador que a resposta desse arquivo é um JSON
    ...
    if(isset( $_REQUEST['buscar'] ) ){
        ...
        $conn = mysqli_connect($local, $user, $password, $banco); //abriu conexão com bd
        if( $conn ){
            ...
            mysqli_close($conn); // fecha conexão bd
            echo '{ "produtos" : '.json_encode($linhas).' }'; //Transforma a query em JSON
        }
